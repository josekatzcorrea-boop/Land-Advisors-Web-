...
$port = 8765
$url = "http://127.0.0.1:$port/brochure/corporativo/index.html?export=pdf"
...
# Alta resolución: escala 3× + A4 @ ~300 DPI + tiempo para cargar fuentes
& $chrome `
  --headless=new `
...
Write-Host "Formato A4 vertical · 6 páginas · brochure digital"
